...
model = dict(
    ...
    loss_heatmap2d=dict(type='MSELoss', loss_weight=1),
...
data_keys = [
    'has_smpl', 'has_keypoints3d', 'has_keypoints2d', 'keypoints2d_map', 'keypoints3d_map', 'sample_idx', 'bbox_xywh', 'centermap', 'valid_mask', 'heatmap2d'
]
train_pipeline = [
    ...
    dict(type='Generate2DHeatmap', img_res=img_res, heatmap_size=(img_res // 4, img_res // 4), sigma=3),
